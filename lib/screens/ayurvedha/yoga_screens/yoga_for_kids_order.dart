...
class YogaForKidsOrder extends StatelessWidget {
  const YogaForKidsOrder({super.key});
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/kids_yoga.png'),
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/kids_yoga.png'),
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/kids_yoga.png'),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                context.go('/yoga_for_kids_confirm');
                              },
