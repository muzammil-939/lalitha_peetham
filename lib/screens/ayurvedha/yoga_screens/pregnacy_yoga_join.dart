...
class PregnacyYogaJoin extends StatelessWidget {
  const PregnacyYogaJoin({super.key});
                  ...
                  Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/pregnancy.png'),
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/pregnancy.png'),
                        SizedBox(height: 12),
                        _buildSidebarImage('assets/images/pregnancy.png'),
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(
                              onPressed: () {
                                context.go('/pregnancy_yoga_confirm');
                              },
