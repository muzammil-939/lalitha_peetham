...
class AyurvedhaArticleSubmit extends StatefulWidget {
  const AyurvedhaArticleSubmit({super.key});

  @override
  State<AyurvedhaArticleSubmit> createState() => _AyurvedhaArticleSubmitState();
}

class _AyurvedhaArticleSubmitState extends State<AyurvedhaArticleSubmit> {
  @override
