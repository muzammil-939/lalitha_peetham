      ...
      children: [
        ...
        Container(
          ...
          decoration: BoxDecoration(
            color: const Color(0x99FFFFFF), // Light beige color matching the reference
        ...
        Container(
          ...
          width: 120,
          decoration: BoxDecoration(
            color: const Color(0xFFFFFFCC), // Same color as medicine container
            borderRadius: BorderRadius.circular(0),
            boxShadow: [
              BoxShadow(
                color: Colors.black.withOpacity(0.1),
  ...
  return Container(
    ...
    decoration: BoxDecoration(
      image: DecorationImage(
        image: AssetImage('assets/images/ayurveda_hero_banner.png'), // Replace with your image path
        fit: BoxFit.cover,
      ),
    ),
    child: Container(
