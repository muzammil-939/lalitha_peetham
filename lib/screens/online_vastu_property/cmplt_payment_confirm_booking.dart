...
class CmpltPaymentConfirmBooking extends StatefulWidget {
  const CmpltPaymentConfirmBooking({super.key});

  @override
  State<CmpltPaymentConfirmBooking> createState() => _CmpltPaymentConfirmBookingState();
}

class _CmpltPaymentConfirmBookingState extends State<CmpltPaymentConfirmBooking> {
   // Astrologer details
    ...
    return VastupoojaLayout(
      child: SingleChildScrollView(
        child: Column(
          children: [
            buildherosection(),
             buildCmpltPaymentConfirmBooking(),
             SizedBox(height: 80,),
          ],
        ),
      ),
  ...
  Widget buildCmpltPaymentConfirmBooking() {
    return  Stack(
    children: [
