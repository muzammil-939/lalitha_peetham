...
class PalmReadingExplorePackages extends StatefulWidget {
  const PalmReadingExplorePackages({super.key});

  @override
  State<PalmReadingExplorePackages> createState() =>
      _PalmReadingExplorePackagesState();
}

class _PalmReadingExplorePackagesState
    extends State<PalmReadingExplorePackages> {
  @override
        ...
        Center(
          child: Column(
            ...
            children: [
              SizedBox(height: 60),
              const Text(
                "Explore & Choose the Right Package",
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                onPressed: () {
                  ...
                  context.go('/palm_reading_select_packages');
