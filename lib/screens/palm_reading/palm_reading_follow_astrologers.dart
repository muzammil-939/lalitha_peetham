...
class PalmReadingFollowAstrologers extends StatefulWidget {
  ...
  @override
  State<PalmReadingFollowAstrologers> createState() =>
      _PalmReadingFollowAstrologersState();
}

class _PalmReadingFollowAstrologersState
      ...
      children: [
        ...
        Positioned(
          ...
          child: Column(
            children: const [
              Text(
                "Follow the astrologers' guidance to \nclear your problems",
