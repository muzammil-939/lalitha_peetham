...
class CateringRegisterPage extends StatefulWidget {
  const CateringRegisterPage({super.key});

  @override
  State<CateringRegisterPage> createState() => _CateringRegisterPageState();
}

class _CateringRegisterPageState extends State<CateringRegisterPage> {
  @override
    ...
    return CateringLayout(
      child: SingleChildScrollView(
        child: Column(
          children: [
            buildherosection(),
            buildRegisterPartyScreen(context),
            SizedBox(height: 80,)
  ...
  Widget buildRegisterPartyScreen(BuildContext context) {
    return Stack(
        children: [
