...
class FlowerDecoOrderCorfirm extends StatelessWidget {
  const FlowerDecoOrderCorfirm({super.key});
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    // Service Title
                    const Text(
                      'Artificial Grassmat Natural Flower Decor',
                      style: TextStyle(
                        fontSize: 18,
                    ...
                    // Starting Date
                    const Text(
                      'Decoration Area : Stage + Entrance',
                      style: TextStyle(fontSize: 14, color: Colors.black87),
                    ),
                    const SizedBox(height: 12),
