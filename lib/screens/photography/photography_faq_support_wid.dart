...
class PhotographyFaqSupportWid extends StatefulWidget {
  const PhotographyFaqSupportWid({super.key});

  @override
  State<PhotographyFaqSupportWid> createState() =>
      _PhotographyFaqSupportWidState();
}

class _PhotographyFaqSupportWidState extends State<PhotographyFaqSupportWid> {
  @override
