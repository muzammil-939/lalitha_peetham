...
class PhotographyPackages2 extends StatelessWidget {
  const PhotographyPackages2({super.key});
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildServiceOption(
            isSelected: false,
            text: "Deliver photos in optimized format for social media (+ €50)",
          ),
          SizedBox(height: 16),
          _buildServiceOption(
            isSelected: false,
            text: "Photos without post-processing (+ €750)",
          ),
          SizedBox(height: 16),
          _buildServiceOption(
            isSelected: false,
            text: "Express delivery within 7 days (+ €300",
          ),
            ...
            children: [
              ...
              Expanded(
                child: GestureDetector(
                  onTap: () => context.go('/photography_packages_3'),
                  child: Container(
                    height: 48,
                    decoration: BoxDecoration(
