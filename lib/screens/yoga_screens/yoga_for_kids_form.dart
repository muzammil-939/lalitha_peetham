...
class YogaForKidsForm extends StatefulWidget {
  const YogaForKidsForm({super.key});

  @override
  _YogaForKidsFormState createState() => _YogaForKidsFormState();
}

class _YogaForKidsFormState extends State<YogaForKidsForm> {
  ...
  Widget _buildSubmitButton() {
    return GestureDetector(
      onTap: () => context.go('/yoga_for_kids_select'),
      child: Container(
