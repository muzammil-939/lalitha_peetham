...
class UpcomingPoojasScreen extends StatefulWidget {
  const UpcomingPoojasScreen({super.key});

  @override
  State<UpcomingPoojasScreen> createState() => _UpcomingPoojasScreenState();
}

class _UpcomingPoojasScreenState extends State<UpcomingPoojasScreen> {

    final poojaList = [
      {'image': 'assets/images/e_pooja1.jpg', 'title': 'Rudrabhishek Puja','path': null},
      {'image': 'assets/images/e_pooja2.jpg', 'title': 'Satyanarayan Puja','path': null},
      {'image': 'assets/images/e_pooja3.jpg', 'title': 'Rahu Puja', 'path': '/about_rahu_pooja'},
      {'image': 'assets/images/e_pooja4.jpg', 'title': 'Ganesh Pooja','path': null},
      {'image': 'assets/images/e_pooja5.jpg', 'title': 'Durga Pooja','path':null},
      {'image': 'assets/images/e_pooja6.jpg', 'title': 'Durga Pooja','path': null},
    ];
...
bool isTablet = ResponsiveHelper.isMobile(context);
  ...
  Widget buildUpcommingpoojas(BuildContext context) {
  bool isMobile = ResponsiveHelper.isMobile(context);

  return Padding(
    padding: EdgeInsets.symmetric(horizontal: isMobile ? 16 : 150.0),
    child: Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Container(
          ...
          child: const Text("Upcoming Poojas"),
        ),
        const SizedBox(height: 30),
        Stack(
  ...
  Widget _buildPoojaCard(BuildContext context,
      {required String imagePath, required String title, required String? path }) {
    bool isMobile = ResponsiveHelper.isMobile(context);
