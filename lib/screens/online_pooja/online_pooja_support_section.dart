...
// bool isMyBookingsSelected = false;
...
//                 runSpacing: 12,
//                 children: [
//                   buildButton("My Bookings", isActive: false,path: '/mybookings_page'),
                  
//                   buildButton("Support", isActive: true,path: ''),
//                 ],
//               ),
//               SizedBox(height: spacing),
//               Container(
...
//   Widget buildButton(String label, {bool isActive = false,required String path}) {
...
class _OnlinePoojaSupportSectionState extends State<OnlinePoojaSupportSection> {
  final TextEditingController fullNameController = TextEditingController();
final TextEditingController emailController = TextEditingController();
final TextEditingController issueController = TextEditingController();
final TextEditingController commentController = TextEditingController();
